/* @mitojs/wx-mini-performance version ' + 2.1.15 */
'use strict';
...
function replaceApp(store) {
    if (App) {
        ...
        App = function (appOptions) {
            var methods = Object.keys(Events).filter(function (m) { return m.indexOf('App') !== -1; });
...
function replacePageLifeMethods(options, store) {
    var pageLifeMethods = Object.keys(Events).filter(function (m) { return m.indexOf('Page') !== -1; });
        ...
        Object.keys(options).forEach(function (m) {
            ...
            replaceOld(options, m, function (originMethod) {
                return function () {
                    ...
                    var event = args.find(function (arg) { return arg && arg.type && arg.currentTarget; });
            ...
            value: function () {
                ...
                switch (hook) {
                    ...
                    case 'uploadFile':
                        ...
                        reqData = __assign(__assign({}, reqData), { filePath: filePath });
                        break;
                }
...
function initWxHideReport(store, immediately, onAppHideReport) {
    if (immediately || !onAppHideReport)
        return;
...
var Event = (function () {
    ...
    Event.prototype.emit = function (event) {
        ...
        if (!this.events.has(event))
            return false;
        var ls = this.events.get(event) || [];
        ls.forEach(function (fn) { return fn.apply(_this, args); });
        return true;
    };
    Event.prototype.remove = function (event, listener) {
        var ls = this.events.get(event) || [];
        var es = ls.filter(function (f) { return f !== listener; });
...
var Store = (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [3, 4];
                    case 4: return [2, nk.networkType];
                }
            });
        });
    };
    Store.prototype._createPerformanceData = function (type, item) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this._getNetworkType()];
                    case 1:
                        networkType = _a.sent();
                        date = new Date();
                        return [2, {
    ...
    Store.prototype.simpleHandle = function (type, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this._createPerformanceData(type, [data])];
                    case 1:
                        d = _a.sent();
                        this._pushData([d]);
                        return [2];
    ...
    Store.prototype.handleMemoryWarning = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this._createPerformanceData(WxPerformanceDataType.MEMORY_WARNING, [
    ...
    Store.prototype.filterUrl = function (url) {
        if (this.ignoreUrl && this.ignoreUrl.test(url))
            return true;
        return false;
    };
    return Store;
